...
const attractions = [
  {
    ...
    since: "1899",
    blurb: "A timeless tradition celebrating agriculture, community, and heritage every September.",
    href: "/#events",
  },
  {
    name: "Pike Festival",
    since: "1972",
    blurb: "Honor national history with unique artisans and local foods. Memorial Day weekend.",
    href: "/pike-festival",
  },
  {
    name: "Farmer's Market",
    since: "2018",
    blurb: "Local growers and artisans, 3rd Saturday of the month between June and October.",
    href: "/farmers-market",
  },
];
        ...
        {attractions.map((t) => (
          <Link key={t.name} href={t.href} className="no-underline text-ink block">
            ...
            <div className="flex justify-between items-baseline mb-2">
              ...
              <span className="num eyebrow" style={{ opacity: 0.5 }}>
                Since {t.since}
              </span>
            </div>
            <h3
            ...
            <p className="m-0" style={{ fontSize: 15, lineHeight: 1.55, color: "rgba(28,24,20,0.7)" }}>
              {t.blurb}
            </p>
          </Link>
        ))}
