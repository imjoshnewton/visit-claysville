...
function EventRow({ ev, idx }: { ev: (typeof EVENTS)[number]; idx: number }) {
  ...
  return (
    ...
    >
      ...
      <h4
        className="m-0"
        style={{ margin: "14px 0 8px", fontFamily: "var(--serif-display)", fontSize: 22, fontWeight: 400, lineHeight: 1.15 }}
      >
        {ev.name}
      </h4>
      <div
...
export function EventBoard() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div className="stamp mb-3.5" style={{ borderColor: "var(--mustard)", color: "var(--mustard)" }}>
            Next up · {featured.tag}
          </div>
          <h3
            className="m-0 mb-3"
            style={{
      ...
      <div
        ...
        style={{
          ...
          gap: 0,
          borderTop: "1px solid rgba(243,235,220,0.15)",
        }}
      >
