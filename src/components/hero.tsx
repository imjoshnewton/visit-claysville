...
export function Hero() {
  return (
    <section
      ...
      style={{ padding: "80px 80px 100px", background: "var(--paper)" }}
    >
      <div className="grid items-center gap-16" style={{ gridTemplateColumns: "1.1fr 1fr" }}>
        <div>
          ...
          <p
            className="m-0"
            style={{ maxWidth: 520, fontSize: 19, lineHeight: 1.55, color: "rgba(28,24,20,0.78)" }}
          >
        ...
        <div className="relative">
          ...
          >
            <div>
              ...
              <div style={{ fontFamily: "var(--serif-display)", fontWeight: 500, fontSize: 34, lineHeight: 1 }}>
                1817
              </div>
