...
export function MarketDates() {
  return (
    <section style={{ padding: "80px 80px", background: "var(--ink)", color: "var(--paper)" }}>
      ...
      <div className="grid gap-4" style={{ gridTemplateColumns: "repeat(5, 1fr)" }}>
        {MARKET_DATES.map((d, i) => (
          ...
          >
            ...
            <div className="num" style={{ fontFamily: "var(--serif-display)", fontSize: 80, lineHeight: 0.9 }}>
              {d.d}
            </div>
            <div className="eyebrow mt-3.5" style={{ opacity: 0.65 }}>Saturday · 9 AM – 1 PM</div>
            <div className="mt-2" style={{ fontSize: 13, color: "rgba(243,235,220,0.7)", lineHeight: 1.5 }}>
              {d.tag}
            </div>
          </div>
        ))}
