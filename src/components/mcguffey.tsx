...
export function McGuffey() {
  return (
    <section style={{ padding: "80px 80px", background: "var(--navy)", color: "var(--paper)", position: "relative" }}>
      ...
      <div className="grid items-center gap-16" style={{ gridTemplateColumns: "1.2fr 1fr" }}>
        <div>
          ...
          <p
            className="mt-6 m-0"
            style={{ maxWidth: 540, fontSize: 16, lineHeight: 1.65, color: "rgba(243,235,220,0.78)" }}
          >
        ...
        <div className="grid gap-6" style={{ gridTemplateColumns: "1fr 1fr" }}>
          {stats.map((s) => (
            <div
              key={s.label}
              style={{
                border: "1.5px solid rgba(243,235,220,0.25)",
                padding: "28px 22px",
            ...
            >
              <div
                className="num"
                style={{ fontFamily: "var(--serif-display)", fontSize: 64, lineHeight: 0.95, color: "var(--mustard)" }}
              >
                {s.stat}
              </div>
              <div className="eyebrow mt-2.5" style={{ opacity: 0.7 }}>
                {s.label}
              </div>
            </div>
          ))}
